package com.sutherland.login.controller;
...
import com.sutherland.login.service.LoginService;
...
public class LoginController {
    ...
    @PostMapping("/addUser")
    public String addUser(@RequestBody LoginEntity login) {
        loginService.addUser(login);
        return "User added successfully!";
    }

    @GetMapping("/getUser/{userId}")
    public LoginEntity getUserById(@PathVariable int userId) {
